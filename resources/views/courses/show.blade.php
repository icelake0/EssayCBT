    ...
    <div class="white-box">
        <div class="row">
            <div class="col-sm-12 col-xs-12">
              ...
              <a class="btn btn-sm btn-success" href="{{route('questions.list',['course'=>$course->id])}}">
                <i class="fa fa-list-alt"></i> Questions</a>
              
              @endrole
              <a class="btn btn-sm btn-primary" href="{{route('exams.list',['course'=>$course->id])}}"><i class="fa fa-table"></i> Exmas</a>
            </div>
        </div>
    </div>
</div>
